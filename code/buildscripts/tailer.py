#!/usr/bin/env python
#
# $Id: tailer.py 9318 2011-06-10 02:37:10Z nathan_george $
#
...
class Tailer(object):
    ...
    def follow(self, delay=1.0, terminate=None):
        """\
        ...
        while 1:
            ...
            if line:
                ...
                trailing = False
                yield line
            elif delay_total > delay_max and terminate and terminate() != None:
                return
            else:
                trailing = True
                self.seek(where)
